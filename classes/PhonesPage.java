...
public class PhonesPage extends HttpServlet  {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (String key : phonesMap.keySet()) {
        	...
        	out.print("<li>\n\n<div style=\"display: inline-block;width:40%;\">\n<img src=\"images/"+phone.getImageName()+"\" "
        			+ "style=\"width: 100px; height: 100px;\">\n<h5 style=\"font-size: 17px; margin-bottom: -10px; "
        			+ "padding-left: 10px;\">"+phone.getProductName()+"</h5>\n<p style=\"margin-bottom: 5px;padding-left: 10px;"
        			+ " font-size: 10px;\"> by "+phone.getCompanyName()+"</p>\n<p style=\"margin-bottom: 0px;\">$"+phone.getPrice()+"</p>"
