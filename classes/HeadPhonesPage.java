...
public class HeadPhonesPage extends HttpServlet  {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (String key : headphonesMap.keySet()) {
        	...
        	out.print("<li>\n\n<div style=\"display: inline-block;width:40%;\">\n<img src=\"images/"+headphone.getImageName()+"\" "
        			+ "style=\"width: 100px; height: 100px;\">\n<h5 style=\"font-size: 17px; margin-bottom: -10px; "
        			+ "padding-left: 10px;\">"+headphone.getProductName()+"</h5>\n<p style=\"margin-bottom: 5px;padding-left: 10px;"
        			+ " font-size: 10px;\"> by "+headphone.getCompanyName()+"</p>\n<p style=\"margin-bottom: 0px;\">$"+headphone.getPrice()+"</p>"
        			+ "\n</div>\n<div style=\"display: inline-block;width:20%;\">\n<form action=\"cart	\">\n<button type=\"submit\" value=\""+key+"\" name=\"cart\">Add to cart</button>\n</form>\n\n"
                      + "<form action=\"WriteReviews\" method=\"get\">"
                      +"<input type=\"hidden\" name=\"productName\" value =\""+headphone.getProductName() +" \"> </input> "
                      +
                      "<input type=\"hidden\" name=\"retailer\" value =\""+headphone.getCompanyName() +" \"> </input> "
                      +
                      "<input type=\"hidden\" name=\"price\" value =\""+headphone.getPrice() +" \"> </input> "
                      +
                      "<input type=\"hidden\" name=\"category\" value =\"Headphones\"> </input> "
                      +
                      "<button type=\"submit\" value=\""+key+"\" name=\"cart\">WriteReview</button></form>\n<br>"
                      +"<form action=\"ViewReviews\" method=\"get\">"
                      +"<input type=\"hidden\" name=\"productName\" value =\""+headphone.getProductName() +" \"> </input> "
                      +"<button type=\"submit\" value=\""+key+"\" name=\"cart\">ViewReview</button></form>"
                      +"</div>\n</li>\n<br>");
		}
        out.print("\n</ul>");
        out.print("</article>\n</section>\n<aside class=\"sidebar\">\n<br><br>\n<ul>\n<li>\n<h4>Categories</h4>\n<ul>\n");
