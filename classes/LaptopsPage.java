...
public class LaptopsPage extends HttpServlet  {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (String key : laptopsMap.keySet()) {
        	...
        	out.print("<li>\n\n<div style=\"display: inline-block;width:40%;\">\n<img src=\"images/"+laptops.getImageName()+"\" "
        			+ "style=\"width: 100px; height: 100px;\">\n<h5 style=\"font-size: 17px; margin-bottom: -10px; "
        			+ "padding-left: 10px;\">"+laptops.getProductName()+"</h5>\n<p style=\"margin-bottom: 5px;padding-left: 10px;"
        			+ " font-size: 10px;\"> by "+laptops.getCompanyName()+"</p>\n<p style=\"margin-bottom: 0px;\">$"+laptops.getPrice()+"</p>"
        			+ "\n</div>\n<div style=\"display: inline-block;width:20%;\">\n<form action=\"cart	\">\n<button type=\"submit\" "
        			+ "value=\""+key+"\" name=\"cart\">Add to cart</button>\n</form>\n\n"
                      +"<form action=\"WriteReviews\" method=\"get\">"
                      +"<input type=\"hidden\" name=\"productName\" value =\""+laptops.getProductName() +" \"> </input> "
                      +
                      "<input type=\"hidden\" name=\"retailer\" value =\""+laptops.getCompanyName() +" \"> </input> "
                      +
                      "<input type=\"hidden\" name=\"price\" value =\""+laptops.getPrice() +" \"> </input> "
                      +
                      "<input type=\"hidden\" name=\"category\" value =\"Laptops\"> </input> "
                      +
