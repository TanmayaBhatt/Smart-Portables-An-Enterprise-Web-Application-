...
function doCompletion() {
    ...
    req.send(null);
   //document.write(searchId.value);
   // document.write(complete);
    //document.write(req);
   // document.write(req.readState);
    }
...
function appendProduct(productName,productId) {
    ...
    if (isIE) {
			...
			completeTable.style.background = '#ffffff';
			completeTable.style.left = '74%'; 
			completeTable.style.fontSize='3';
            ...
            linkElement.setAttribute("href", "AutoProduct?action=lookup&searchId=" +productId); 
